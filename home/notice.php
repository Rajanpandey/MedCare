...
$num_rec_per_page=10;
$selecAllIssues = "SELECT * FROM notices";
...
$sql="SELECT * FROM notices ORDER BY date DESC LIMIT $start_from, $num_rec_per_page";
...
?>
    ...
    if($page==1){
        ?>
        <li class="page-item disabled"><a class="page-link" href='myqueries.php?page=1'> << </a></li>
    <?php
    }
    else {
        ?>
        <li class="page-item"><a class="page-link" href='myqueries.php?page=1'> << </a></li>
    <?php
    }    
    ...
    if($total_pages<=5) {
        for ($i=1; $i<=$total_pages; $i++) { 							 
            if($i == $page){	
                ...
                ?>
                <li class="page-item"><a class="page-link" href='myqueries.php?page=<?php echo "$i" ?>'><?php echo "$i" ?></a></li>
            <?php	
            }							
        };
    }
    ...
    if($page==$total_pages){
    ?>
    <li class="page-item disabled"><a class="page-link" href='myqueries.php?page=<?php echo "$total_pages" ?>'> >> </a></li>	
    <?php
    }
    else {
        ?>
        <li class="page-item"><a class="page-link" href='myqueries.php?page=<?php echo "$total_pages" ?>'> >> </a></li>	
     <?php	
        }
    ?>
</ul> 
